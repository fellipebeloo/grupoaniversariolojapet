...
const AffiliateGroupPage = () => {
  ...
  return (
    <div className="h-dvh w-full bg-[#0f1418] flex flex-col items-center justify-center p-4">
      ...
      <header className="text-center mb-8">
        ...
        <p className="text-gray-400">Participe do nosso grupo exclusivo da Black Friday.</p>
      </header>
      ...
      <div className="mt-8 w-full max-w-md">
        <button
          ...
          className="w-full py-4 bg-[#00a884] text-white font-bold rounded-lg shadow-lg hover:bg-[#008f6f] transition-transform transform hover:scale-105 text-lg"
        >
