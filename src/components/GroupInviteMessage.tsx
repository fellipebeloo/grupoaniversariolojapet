  ...
  return (
    <div className="flex flex-col rounded-lg bg-white text-gray-800 shadow-lg overflow-hidden">
      <div className="p-3 flex items-center gap-3 bg-gray-50">
        <div className="w-12 h-12 bg-[#1A55A1] rounded-lg flex items-center justify-center flex-shrink-0">
      ...
      <div className="p-3 text-left">
        <p className="text-sm text-gray-600">
          ...
          <br />
          <span className="text-[#DA3A5B] break-all font-medium">{inviteLink}</span>
        </p>
      </div>
      ...
      <div className="border-t border-gray-200">
        <button
          ...
          className="w-full text-center py-3 px-3 text-[#1A55A1] hover:bg-gray-100 transition-colors text-sm font-bold"
        >
          {buttonText}
        </button>
      </div>
