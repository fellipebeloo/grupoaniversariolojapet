export const AlessandraAudios = {
  introConsciencia: '/intro-consciencia.ogg',
  consciencia1: '/consciencia1.ogg',
  consciencia2: '/consciencia2.ogg',
  consciencia3: '/consciencia3.ogg',
  consciencia4: '/consciencia4.ogg',
  consciencia5: '/consciencia5.ogg',
  correct1: '/correct1.ogg',
  correct2: '/correct2.ogg',
  correct3: '/correct3.ogg',
  ...
  messageSent: '/message-sent.ogg', // Efeito sonoro de mensagem enviada
  messageReceived: '/message-received.ogg', // Efeito sonoro de mensagem recebida
};